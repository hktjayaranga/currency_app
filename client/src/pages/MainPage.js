...
export default function MainPage() {
  ...
  return (
    <div>
            ...
            <section className='w-full lg:w-1/2'>
                <form onSubmit={handleSubmit}>
                    ...
                    <div className="mb-4">
                        ...
                        name="sourceCurrency" id="sourceCurrency" value={sourceCurrency}  className="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-green-500 focus:border-green-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-green-500 dark:focus:border-green-500">
        ...
        {!loading ? <section className='mt-5 lg:mx-60 '>
